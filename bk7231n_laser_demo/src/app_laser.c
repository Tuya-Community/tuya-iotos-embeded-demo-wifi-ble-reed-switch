 ...
 * @LastEditTime: 2021-03-23 15:42:50
 */
...
OPERATE_RET app_laser_init(IN APP_MODE mode)
{
...
VOID app_report_all_dp_status(VOID)
{
    ...
    dp_arr[0].dpid = DPID_LASER_SWITCH;
    dp_arr[0].type = PROP_BOOL;
    dp_arr[0].time_stamp = 0;
    dp_arr[0].value.dp_value = app_ctrl_data.laser_switch;
...
VOID deal_dp_proc(IN CONST TY_OBJ_DP_S *root)
{
    ...
    case DPID_LASER_SWITCH:
        app_ctrl_data.laser_switch = root->value.dp_bool;
        break;
    default:
        break;
    }
